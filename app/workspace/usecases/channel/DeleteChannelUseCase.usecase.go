...
func DeleteChannelUseCase(ctx *gin.Context, channel_id string) (bool, error) {
	...
	has_access := workspaceModel.HasAccess(channelMembership.AdminAccess,
		[]constants.ChannelAdminAccess{constants.CHANNEL_FULL_ACCESS, constants.CHANNEL_DELETE_ACCESS})
	if !has_access {
